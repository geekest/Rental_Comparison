...
- [x] Phase 9：完整 XCTest / XCUITest 验证；iPhone 16e Simulator 共 36 项通过，含按候选进入现场验证并一键记录结果的 UI 路径，以及计划指定 A/B/C 决策场景的端到端领域回归。
...
- 2026-08-19 回归：Unknown / Viewing 闭环、v2 合并保护、地区模板边界和截图来源区分加入后，iPhone 16e Simulator 完整测试共 36 项通过；A/B/C 场景覆盖 C 硬冲突、A 费用未知与确认、B 噪音观察、最终确认与撤回；iPhone 17 重新构建、安装并启动当前 Debug 包成功。
